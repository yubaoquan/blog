...
spa.avtr = (function() {
  ...
  var
    ...
    stateMap = {
      drag_map : null,
      $drag_target : null,//here may exists some problem.
      drag_bg_color : undefined
    },
    jqueryMap = {},

    getRandRgb, setJqueryMap, updateAvatar, onTapNav,
    onHeldstartNav, onHeldmoveNav, onHeldendNav, onSetchatee,
    onListchange, onLogout, configModule, initModule;
